      ...
      <>
        <div style={{ height: '80vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <div className='col-md-6'>
            <Form className='card bg-white' onSubmit={this.handleSubmit} id='form'>
              ...
              <div className='pl-lg-3 pr-lg-3'>
                <div className='pl-lg-5 pr-lg-5 pb-4 pt-4'>
                  ...
                  <Row className='row justify-content-center'>
                    ...
                    <Col className='col-md-5'>
                      <Button variant='outline-success' className='w-100' onClick={() => useHistory().push('/airnote/courses')}>Cancel</Button>
                    </Col>
                  </Row>
                </div>
              </div>
